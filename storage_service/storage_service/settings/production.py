...
DATABASES = {
    'default': {
        'ENGINE': get_env_variable('SS_DB_ENGINE'), # django.db.backends.sqlite3 Add 'postgresql_psycopg2', 'postgresql', 'mysql', 'sqlite3' or 'oracle'.
        ...
        'PORT': get_env_variable('SS_DB_PORT'),  # Set to empty string for default. Not used with sqlite3.
    },
}
