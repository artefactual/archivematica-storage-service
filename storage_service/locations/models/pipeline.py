...
class Pipeline(models.Model):
    ...
    def create_default_locations(self, shared_path=None):
        ...
        LOGGER.info("Creating default locations for pipeline {}.".format(self))
        ...
        if space_created:
            ...
            local_fs.save()
            LOGGER.info("Protocol Space created: {}".format(local_fs))
        ...
        LOGGER.info("Currently processing: {}".format(currently_processing))
        ...
        for p in purposes:
            ...
            for uuid in defaults:
                ...
                LOGGER.info("Adding new {} {} to {}".format(
