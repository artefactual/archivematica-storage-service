...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column("locations_file", "package_id")

        # Deleting field 'File.source_package'
        db.delete_column("locations_file", "source_package")

        # Deleting field 'File.accessionid'
        db.delete_column("locations_file", "accessionid")

        # Deleting field 'File.origin'
        db.delete_column("locations_file", "origin")
