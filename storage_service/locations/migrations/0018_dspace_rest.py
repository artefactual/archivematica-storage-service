    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('as_archival_object', models.CharField(help_text='Number of the default ArchivesSpace archival object', max_length=64,
                                              verbose_name='Default ArchivesSpace archival object')),
                ('as_password', models.CharField(help_text='ArchivesSpace password to authenticate with', max_length=64,
                ...
                ('as_url', models.URLField(help_text='URL of ArchivesSpace server. E.g. http://sandbox.archivesspace.org/ (default port 8089 if omitted)', max_length=256,
