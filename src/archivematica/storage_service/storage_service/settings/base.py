...
LOGGING = {
    ...
    "loggers": {
        ...
        "archivematica.storage_service": {"level": "DEBUG"},
        "sword2": {"level": "INFO"},
        "boto3": {"level": "INFO"},
        "botocore": {"level": "INFO"},
    },
...
if CAS_AUTHENTICATION:
    ...
    CAS_CHECK_ADMIN_ATTRIBUTES = is_true(
        environ.get("AUTH_CAS_CHECK_ADMIN_ATTRIBUTES", "")
    )
    ...
    CAS_AUTOCONFIGURE_EMAIL = is_true(environ.get("AUTH_CAS_AUTOCONFIGURE_EMAIL", ""))
